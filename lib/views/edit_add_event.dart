...
class AddEventScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final eventController = Get.put(EventController(), permanent: true);
                  ...
                  Obx(
                    () {
                      return GestureDetector(
                        ...
                        child: (kIsWeb
                                ? eventController.posterPhotoWeb != null
                                : eventController.posterPhoto != null)
                            ? kIsWeb
                                ? Image.memory(
                                    eventController.posterPhotoWeb!,
                                    fit: BoxFit.fill,
                                  )
                                : Image.file(
                  ...
                  Obx(
                    () => DropdownButtonFormField<String>(
                      ...
                      onChanged: (String? newValue) {
                        ...
                        eventController.selectedCategory.value = newValue;
                      },
                      validator: (value) {
                  ...
                  Obx(
                    () => CustomButton(
                      ...
                      loadingWidget: eventController.isLoading.value
                          ...
                          : null,
                      onPressed: () async {
                        if (eventController.selectedCategory.value == null ||
                            eventController.selectedCategory.value!.isEmpty) {
                          Get.snackbar(
                            'Error!',
